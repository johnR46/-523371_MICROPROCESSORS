...
void setup()
{
  ...
  Serial.println("WTC Receiver Callback");
  u8x8.drawString(0, 1, "WTC Receiver");
  delay(1000);
...
void loop()
{
  ...
  {
    String message = "24.5,75";   // send a message
    sendMessage(message);
